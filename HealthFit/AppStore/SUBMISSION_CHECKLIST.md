...
- [x] Screenshots sono (6.7") no Connect
- [x] Archive + upload build **21** (1.0.9)
- [x] Attach build 21 na versão 1.0.9
- [x] Enviado para revisão (**Aguardando revisão** — 20/09/2026)

## App Store Connect

1. https://appstoreconnect.apple.com/apps/6798621208
2. Versão **1.0.9** com build **21** — aguardando revisão
